                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex">
                        ...
                        <div class="flex flex-end justify-end m-2 p-2">
                            <a href="{{route('admin.menus.trash')}}" class="px-4 py-2 text-white bg-indigo-500 hover:bg-indigo-700 rounded-lg">Trash</a>
                        </div>
                    </div>
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex space-x-2">
                                                <a href="{{route('admin.menus.edit', $menu->id)}}" class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-lg text-white font-medium hover:underline">Edit</a>
