            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 bg-slate-100 rounded-lg">
                    <div class="flex m-2 p-2">
                        <a href="{{route('admin.menus.index')}}" class="px-4 py-2 text-white bg-indigo-500 hover:bg-indigo-700 rounded-lg">Menus</a>
                    </div>

                    <div class="m-2 p-2">
                        <div class="space-y-8 divide-y divide-gray-200 mt-10">
                            <form enctype="multipart/form-data" method="POST" action="{{route('admin.menus.update', ['menu' => $menu->id])}}">
                                @csrf
                                @method('PUT')
                              ...
                              <div class="sm:col-span-6">
                                ...
                                <div class="mt-1">
                                    <input type="number" min="0.00" max="10000.00" step="0.01"
                                        id="price" wire:model.lazy="price" name="price" value="{{$menu->price}}"
                              ...
                              <div class="mt-6 p-4">
                                <button type="submit" class="text-white px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg">Update</button>
                              </div>
                            </form>
                          </div>
