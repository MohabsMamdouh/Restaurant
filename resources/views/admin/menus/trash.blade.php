                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex space-x-2">
                                                <a href="{{route('admin.menus.restore', $menu->id)}}" class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-lg text-white font-medium hover:underline">Restore</a>
                                                <form class="px-4 py-2 bg-red-500 hover:bg-red-700 rounded-lg text-white"
                                                        action="{{route('admin.menus.force.delete', $menu->id)}}"
                                                        method="POST"
