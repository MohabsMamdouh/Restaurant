                        ...
                        <div class="space-y-8 divide-y divide-gray-200 mt-10">
                            <form method="POST" action="{{ route('admin.tables.update', $table->id) }}">
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" id="name" wire:model.lazy="name" name="name" value="{{$table->name}}"
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="number" min="0" max="10000" step="1"
                                            id="guest_number" wire:model.lazy="guest_number" name="guest_number" value="{{$table->guest_number}}"
