                        ...
                        <div class="space-y-8 divide-y divide-gray-200 mt-10">
                            <form method="POST" action="{{ route('admin.reservations.update', $reservation->id) }}">
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" id="first_name" wire:model.lazy="first_name" name="first_name" value="{{$reservation->first_name}}"
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" id="last_name" wire:model.lazy="last_name" name="last_name" value="{{$reservation->last_name}}"
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" id="email" wire:model.lazy="email" name="email" value="{{$reservation->email}}"
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="tel" id="tel_number" wire:model.lazy="tel_number" name="tel_number" value="{{$reservation->tel_number}}"
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="datetime-local" id="res_date" wire:model.lazy="res_date" name="res_date" value="{{$reservation->res_date}}" min="{{$min_date}}" max="{{$max_date}}"
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="number" min="0" max="10000" step="1"
                                            id="guest_number" wire:model.lazy="guest_number" name="guest_number" value="{{$reservation->guest_number}}"
